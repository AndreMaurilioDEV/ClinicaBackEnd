...
public class SecurityConfig {
  ...
  @Autowired
  public SecurityConfig(com.betrybe.hospitalExample.security.jwtFilter jwtFilter) {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
    return httpSecurity
            ...
            .authorizeHttpRequests(authorize -> authorize
                    ...
                    .requestMatchers(HttpMethod.POST, "/persons/admins").permitAll()
                    .requestMatchers(HttpMethod.POST, "/persons/employees").hasRole("ADMIN")
  ...
  public AuthenticationManager authenticationManager(
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfig.setAllowCredentials(true);  // Permite enviar cookies e tokens em requisições
